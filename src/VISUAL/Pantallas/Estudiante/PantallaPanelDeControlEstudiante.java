...
public class PantallaPanelDeControlEstudiante extends javax.swing.JFrame {
    ...
    public static String estudianteMostrar;
    ...
    private void initComponents() {
        ...
        tbListaEstudiantes.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbListaEstudiantesMouseClicked(evt);
            }
        });
    ...
    private void tbListaEstudiantesMouseClicked(java.awt.event.MouseEvent evt) {
        int selectedRow = tbListaEstudiantes.getSelectedRow();
        estudianteMostrar = tbListaEstudiantes.getValueAt(selectedRow, 0).toString();

        if (PantallaBuscarPerfil.pantallasAbiertas + 1 == 1) {
            PantallaBuscarPerfil.pantallasAbiertas++;
            PantallaBuscarPerfil panBusPer = new PantallaBuscarPerfil();
            panBusPer.setVisible(true);

        } else {
            JOptionPane.showMessageDialog(null, "YA TIENE UNA PESTAÑA ABIERTA.");
        }
    }
    ...
    private void btnNuevoChatActionPerformed(java.awt.event.ActionEvent evt) {
        if (PantallaChatEstudiante.pantallasAbiertas + 1 == 1) {
            PantallaChatEstudiante.pantallasAbiertas++;
