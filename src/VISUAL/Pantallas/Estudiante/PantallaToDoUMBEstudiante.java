...
public class PantallaToDoUMBEstudiante extends javax.swing.JFrame {
    ...
    /**
     * Creates new form PantallaToDoUMBEstudiante
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaToDoUMBEstudiante.class.getName())
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantallaToDoUMBEstudiante().setVisible(true);
            }
        });
    }
