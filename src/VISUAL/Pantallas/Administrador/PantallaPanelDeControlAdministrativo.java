...
public class PantallaPanelDeControlAdministrativo extends javax.swing.JFrame {
    ...
    public static String correoSeleccionado = "";
    ...
    public void compararMes() {
        ...
        try {
            ...
            while (cx.rs.next()) {
                ...
                int diferenciaMes = mesActual - mesUltimaConexion;
    ...
    private void initComponents() {
        ...
        btnLimpiarCuentas = new javax.swing.JButton();
        ...
        btnLimpiarCuentas.setBackground(new java.awt.Color(220, 220, 220));
        btnLimpiarCuentas.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        btnLimpiarCuentas.setForeground(new java.awt.Color(51, 51, 51));
        btnLimpiarCuentas.setText("Limpiar Cuentas");
        btnLimpiarCuentas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnLimpiarCuentasActionPerformed(evt);
            }
        });
                                        ...
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addGroup(jPanel2Layout
                                                        ...
                                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                                ...
                                                                .addGap(18, 18, 18)
                                                                .addComponent(btnLimpiarCuentas)))
    ...
    private void btnLimpiarCuentasActionPerformed(java.awt.event.ActionEvent evt) {
        compararMes();
    }
    ...
    private javax.swing.JButton btnLimpiarCuentas;
